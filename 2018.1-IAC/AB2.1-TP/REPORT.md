# Identificação
* Página do repositório do trabalho do GitHub [(Link)](https://github.com/gabrielalcantarar/teaching/tree/master/2018.1-IAC/AB2.1-TP)
...
##### GRÁFICO (3) QUE EXPRESSA A UTILIZAÇÃO INTENSA DA UCP E MEMÓRIA (./main ucp-mem):
